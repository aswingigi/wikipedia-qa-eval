...
> **Auto-generated by Claude Code as a working draft — NOT the author's own writeup.**
> To be refined or replaced before submission.

*Worker: `claude-sonnet-4-6`. Judge: `claude-opus-4-8`. Retrieval: live English MediaWiki API,
no caching. Raw Anthropic SDK only.*
